...
describe("DiagnosticsPanel", () => {
  ...
  it("renders warnings separately from failures", () => {
    ...
    render(<DiagnosticsPanel result={result} status={{ kind: "unchanged", durationMs: 1 }} />);
    expect(screen.getByText("Core warning").closest(".warning-callout")).toBeInTheDocument();
  });
});
