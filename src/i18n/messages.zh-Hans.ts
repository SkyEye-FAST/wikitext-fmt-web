...
export const messages: MessageCatalog = {
  ...
  "brand.tagline": "在本地安全运行的 MediaWiki 源代码格式化工具",

  // Language selector
  "language.label": "语言",
  "language.follow-browser": "跟随浏览器语言",
  "language.en": "English",
  ...
  "diagnostics.entries": "{count} 条规则诊断",
  "diagnostics.empty": "最近一次运行没有失败、警告或规则诊断。",
  ...
  "settings.parameter-layout.flush": "齐头",
  ...
  "settings.normalize-blank-lines": "统一空白行",
  ...
  "settings.parser-config.value": "MediaWiki 自带的浏览器配置",
  ...
  "summary.section-spacing-normalized": "已统一章节标题周围的间距。",
  "summary.equivalence-failed": "无法验证 {structure} 的等价性。",

  // Document title and meta
  "document.title.default": "Wikitext Formatter",
  "document.title.example": "示例 — Wikitext Formatter",
  "meta.description":
    "在浏览器中运行的 MediaWiki Wikitext 格式化工具。格式化在本地进行，源代码不会被上传。",
  "meta.og-title": "Wikitext Formatter",
  "meta.og-description": "在浏览器中运行的 MediaWiki Wikitext 格式化工具",
  ...
  "error.worker-invalid-generation": "格式化器 Worker 返回了无效的代次编号。",
  "error.client-disposed": "格式化器客户端已失效。",
